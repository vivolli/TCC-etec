<?php
// canonical copy of php/login/esqueceuSenha.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$email) {
        ...
        try {
            ...
            // image moved to app/public/img — adjust path to new location
            $imageAttachment = __DIR__ . '/../../public/img/fetel.png';
            $embeddedHtml = '';
            ...
            if ($pdo) {
                ...
                if (!$u) {
                    ...
                    $resetUrl = $scheme . '://' . $host . '/TCC-etec/app/php/login/reset.php?token=' . urlencode($token);
