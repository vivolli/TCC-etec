    ...
    <section class="section">
        ...
        <div class="grid">
            <div class="panel">
                ...
                <a class="btn primary" href="/TCC-etec/app/php/biblioteca/catalogo/index.php">Pesquisar catálogo</a>
            </div>

            <div class="panel">
                <h3>Meus Empréstimos</h3>
                <p>Ver tudo que você tem emprestado e solicitar renovação.</p>
                <a class="btn" href="/TCC-etec/app/php/biblioteca/emprestimo/emprestimo.php">Ver empréstimos</a>
            </div>
