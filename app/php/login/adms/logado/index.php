...
if (!esta_logado()) {
    header('Location: /TCC-etec/app/php/login/entrar.php');
    exit;
}
        ...
        <header class="site-header">
            <div class="container header-inner">
                <a class="logo" href="/TCC-etec/index.html">
                    <img src="/TCC-etec/app/public/img/fetel_sem_fundo.png" alt="FETEL" class="logo-img" style="height:72px;width:auto;display:inline-block;vertical-align:middle;">
                </a>
                <nav class="nav" aria-label="Principal">
                    <ul class="nav-list">
                        <li><a href="/TCC-etec/index.html">Início</a></li>
                        <li><a class="active-link" href="/TCC-etec/app/php/login/adms/logado/index.php">Painel</a></li>
                        <li><a href="/TCC-etec/app/php/secretaria/secretaria.php">Secretaria</a></li>
                        <li><a href="/TCC-etec/app/php/login/adms/usuarios.php">Usuários</a></li>
            ...
            <section class="section" id="portal">
                ...
                <div class="cards small">
                    <div class="card action-card" data-action="usuarios">
                        ...
                        <div class="flex"><a class="btn" href="/TCC-etec/app/php/login/adms/usuarios.php">Abrir</a></div>
                    </div>
                    <div class="card action-card" data-action="emprestimos">
                        <div class="icon" aria-hidden="true">📚</div>
                        <h3>Empréstimos</h3>
                        <p>Veja e gerencie livros e materiais emprestados.</p>
                        <div class="flex"><a class="btn" href="/TCC-etec/app/php/emprestimos/emprestimo.php">Ver</a></div>
                    </div>
                    <div class="card action-card" data-action="relatorios">
                        <div class="icon" aria-hidden="true">📊</div>
                        <h3>Relatórios</h3>
                        <p>Gere relatórios de alunos, frequência e uso de recursos.</p>
                        <div class="flex"><a class="btn" href="/TCC-etec/app/php/secretaria/secretaria.php">Gerar</a></div>
                    </div>
                </div>
